...
public class Hyena extends Animal implements Terrestrial, Carnivorus {
	...
	@Override
	public void move() {
		System.out.println("Votre Hyènes " + Hyena.super.getName() + " vient de " + Terrestrial.deplacement);
	}

	@Override
	public void eat(Eatable eatable) {
		if (eatable instanceof Animal) {
			System.out.println("Votre Hyènes " + Hyena.super.getName() + " vient de manger de la " + Carnivorus.nourritureOK);
		}

		else if (eatable instanceof Vegetable) {
			System.out.println("Votre Hyènes " + Hyena.super.getName() + " ne peut pas manger d'" + Carnivorus.nourritureX);
		}
	}
}