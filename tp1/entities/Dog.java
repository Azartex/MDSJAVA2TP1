...
public class Dog extends Animal implements Terrestrial, Omnivorus {
	...
	@Override
	public void move() {
		System.out.println("Votre Chien " + Dog.super.getName() + " vient de " + Terrestrial.deplacement);
	}

	@Override
	public void eat(Eatable eatable) {
		if (eatable instanceof Vegetable || eatable instanceof Animal) {
			System.out.println("Votre Chien " + Dog.super.getName() + " vient de manger " + Omnivorus.nourriture());
		}
	}
}